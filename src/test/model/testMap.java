...
public class testMap {
    ...
    public void runBefore() {
        ...
        b3 = new Bullets(0, Map.HEIGHT + 1, "RIGHT");
        b4 = new Bullets(-1, 0, "LEFT");
        b5 = new Bullets(Map.WIDTH + 1, 0, "UP");
    ...
    public void moveEnemiesTest() {
        Enemies en1 = new Enemies(Map.WIDTH / 2, Map.HEIGHT / 2, 20, "UP");
        Enemies en2 = new Enemies(5, 5, 20, "DOWN");
        ...
        assertEquals((int)(Map.WIDTH / 2 + en1.RATEX *Math.cos(a1)), en1.getXcoord());
        assertEquals((int)(Map.HEIGHT / 2 + en1.RATEY *Math.sin(a1)), en1.getYcoord());
