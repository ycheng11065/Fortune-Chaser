...
//
//        Player p1 = new Player(XSPAWN, Frame.HEIGHT - 1, 20, "UP");
//        p1.moveUp();
//        assertEquals(p1.getXcoord(), XSPAWN);
//        assertEquals(p1.getYcoord(), Frame.HEIGHT);
//
//    }
//
//    @Test
...
//        assertEquals(player.getYcoord(), YSPAWN);
//
//        Player p1 = new Player(Frame.WIDTH - 1 ,YSPAWN, 20, "DOWN");
//        p1.moveLeft();
//        assertEquals(p1.getXcoord(), Frame.WIDTH);
//        assertEquals(p1.getYcoord(), YSPAWN);
//    }
//
//    @Test
...
//        Player p2 = new Player(Frame.WIDTH - 2, Frame.HEIGHT, 20, "UP");
//        p2.moveLeft();
//        p2.moveLeft();
//        p2.moveLeft();
//        assertEquals(p2.getXcoord(), Frame.WIDTH);
//        Player p3 = new Player(2, Frame.HEIGHT, 20, "UP");
//        p3.moveRight();
//        p3.moveRight();
//        p3.moveRight();
//        assertEquals(p3.getXcoord(), 0);
//        Player p4 = new Player(2, Frame.HEIGHT, 20, "UP");
//        p4.moveLeft();
//        p4.moveLeft();
//        p4.moveLeft();
...
//        Player p2 = new Player(Frame.WIDTH, Frame.HEIGHT - 2, 20, "UP");
//        p2.moveUp();
//        p2.moveUp();
//        p2.moveUp();
//        assertEquals(p2.getYcoord(), Frame.HEIGHT);
//        Player p3 = new Player(Frame.WIDTH, 2, 20, "UP");
//        p3.moveDown();
//        p3.moveDown();
//        p3.moveDown();
//        assertEquals(p3.getYcoord(), 0);
//        Player p4 = new Player(Frame.WIDTH, 2, 20, "UP");
//        p4.moveUp();
//        p4.moveUp();
//        p4.moveUp();
